...
[![Tests](https://img.shields.io/badge/tests-206%20passing-brightgreen)](#build-und-tests)
...
- Maven-Reactor: **6/6 SUCCESS**
- Tests: **206**, 0 Failures, 0 Errors, 0 Skips
...
2. `tools/collect_distribution.py` erzeugt unter `dist/plugins/` vier eigene Plugin-JARs und ein Hashmanifest.
...
Vollständige aktuelle Quellen wurden für die fünf oben genannten Module übernommen. Nur als Binärbackup gefunden und daher nicht blind dekompiliert oder produktiv integriert:
